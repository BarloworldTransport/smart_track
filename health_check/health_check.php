...
body {
	...
	#4c4c4c+0,595959+12,666666+25,474747+39,2c2c2c+50,000000+51,111111+60,2b2b2b+76,1c1c1c+91,131313+100;Black+Gloss+%231 */
...
div.dataTables_wrapper {
	padding: 10px;
	/* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/
	#f2f6f8+0,d8e1e7+50,b5c6d0+51,e0eff9+100;Grey+Gloss+%232 */
	background: rgb(242, 246, 248); /* Old browsers */
	background: -moz-linear-gradient(-45deg, rgba(242, 246, 248, 1) 0%,
		rgba(216, 225, 231, 1) 50%, rgba(181, 198, 208, 1) 51%,
		rgba(224, 239, 249, 1) 100%); /* FF3.6-15 */
	background: -webkit-linear-gradient(-45deg, rgba(242, 246, 248, 1) 0%,
		rgba(216, 225, 231, 1) 50%, rgba(181, 198, 208, 1) 51%,
		rgba(224, 239, 249, 1) 100%); /* Chrome10-25,Safari5.1-6 */
	background: linear-gradient(135deg, rgba(242, 246, 248, 1) 0%,
		rgba(216, 225, 231, 1) 50%, rgba(181, 198, 208, 1) 51%,
		rgba(224, 239, 249, 1) 100%);
	/* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f2f6f8',
		endColorstr='#e0eff9', GradientType=1) width:100%;
}
</style>
<script>
...
<body>
	...
	<div align="center">
		<div class="GaugeMeter" id="opened" data-percent="40" data-append="%"
			data-size="200" data-theme="DarkBlue-LightBlue"
			data-back="RGBa(0,0,0,.1)" data-animate_gauge_colors="1"
			data-animate_text_colors="1" data-width="15" data-label="FM Updating"
			data-style="Full" data-label_color="#FFF"></div>

		<div class="GaugeMeter" id="opened" data-percent="40" data-append="%"
			data-size="200" data-theme="DarkBlue-LightBlue"
			data-back="RGBa(0,0,0,.1)" data-animate_gauge_colors="1"
			data-animate_text_colors="1" data-width="15"
			data-label="Skytrack Updating" data-style="Full"
			data-label_color="#FFF"></div>

		<div class="GaugeMeter" id="completed" data-percent="95"
			data-append="%" data-size="200" data-theme="DarkBlue-LightBlue"
			data-back="RGBa(0,0,0,.1)" data-animate_gauge_colors="1"
			data-animate_text_colors="1" data-width="15"
			data-label="Drivecam Updating" data-style="Full"
			data-label_color="#FFF"></div>

		<div class="GaugeMeter" id="completed" data-percent="85"
			data-append="%" data-size="200" data-theme="DarkBlue-LightBlue"
			data-back="RGBa(0,0,0,.1)" data-animate_gauge_colors="1"
			data-animate_text_colors="1" data-width="15" data-label="MX Updating"
			data-style="Full" data-label_color="#FFF"></div>

		<div class="GaugeMeter" id="completed" data-percent="90"
			data-append="%" data-size="200" data-theme="DarkBlue-LightBlue"
			data-back="RGBa(0,0,0,.1)" data-animate_gauge_colors="1"
			data-animate_text_colors="1" data-width="15"
			data-label="Beame Updating" data-style="Full" data-label_color="#FFF"></div>

		<div class="GaugeMeter" id="completed" data-percent="98"
			data-append="%" data-size="200" data-theme="DarkBlue-LightBlue"
			data-back="RGBa(0,0,0,.1)" data-animate_gauge_colors="1"
			data-animate_text_colors="1" data-width="15"
			data-label="Vehicle Uptime" data-style="Full" data-label_color="#FFF"></div>
	</div>
		...
		<table class="table table-bordered table-hover table-striped"
			...
			<tbody>
                ...
                $sql_data = mysqli_query($con, "SELECT 
                        skytrack_positions.skytrack_positions_latitude,
                        skytrack_positions.skytrack_positions_longitude,
                        skytrack_positions.skytrack_positions_unit_id,
                        skytrack_positions.skytrack_positions_time,
                        vehicle.fm_id,
                        unit_trip_download.trip_download_fm_odometer,
                        unit_trip_download.trip_download_download_date,
                        vehicle.fleet_number,
                        positions.position_time,
                        vehicle.fleet_group,
                        vehicle.registration_number,
                        positions.position_latitude,
                        positions.position_longitude
                	FROM vehicle
                ...
                while ($get_data = mysqli_fetch_array($sql_data)) {
                    ...
                    $sql_location = mysqli_query($con, "SELECT 
                            location_name 
                        FROM locations 
                        WHERE ($latitude BETWEEN location_latitude1 AND location_latitude2) 
                        AND ($longitude BETWEEN location_longitude1 AND location_longitude2)");
