				...
				<form class="add_schedule" name="add_schedule" method="post"
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="fleet_number"
								name="fleet_number" placeholder="Enter Vehicle"
					...
					<div class="form-group">
						<div class="input-group">
							...
							<textarea class="form-control" id="repair_desc"
								name="repair_desc" rows="3" readonly><?php echo $get_data['unit_fault_fault_desc']; ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="repair_location"
								name="repair_location"
								placeholder="Please enter the repair location">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="schedule_date"
								name="schedule_date" onchange="get_day_bookings()">
						</div>
					</div>
