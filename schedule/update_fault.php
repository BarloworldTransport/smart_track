				...
				<form class="contact" name="contact">
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="unit_fault_sr_number"
								placeholder="Enter Vehicle" name="unit_fault_sr_number"
								value="<?php echo $get_data['unit_fault_sr_number']; ?>"
								readonly>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							...
							<select id="unit_fault_fleet_number"
								class=" form-control selectpicker" data-live-search="true"
								name="unit_fault_fleet_number" onchange="get_registration()">
								<option
									value="<?php echo $get_data['unit_fault_fleet_number']; ?>"
									selected="<?php echo $get_data['unit_fault_fleet_number']; ?>"><?php echo $get_data['unit_fault_fleet_number']; ?></option>";
                                <?php
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control"
								id="unit_fault_registration_number"
								name="unit_fault_registration_number"
								value="<?php echo $get_data['unit_fault_registration_number']; ?>">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon">Fleet</div>
							<input type="text" class="form-control" id="unit_fault_fleet"
								name="unit_fault_fleet"
								value="<?php echo $get_data['unit_fault_fleet']; ?>">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							...
							<select id="unit_fault_unit_type"
								class=" form-control selectpicker" data-live-search="true"
								name="unit_fault_unit_type">
								<option value="<?php echo $get_data['unit_fault_unit_type']; ?>"
									selected="<?php echo $get_data['unit_fault_unit_type']; ?>"><?php echo $get_data['unit_fault_unit_type']; ?></option>";
                                <?php
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control"
								id="unit_fault_fault_desc" name="unit_fault_fault_desc"
								placeholder="Enter Location"
								value="<?php echo $get_data['unit_fault_fault_desc']; ?>">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon">Comments</div>
							<textarea class="form-control" id="unit_fault_comments"
								name="unit_fault_comments" rows="3"><?php echo $get_data['unit_fault_comments']; ?></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-addon">Repair Status</div>
							<select id="unit_fault_status" class=" form-control selectpicker"
								data-live-search="true" name="unit_fault_status">
								<option value="<?php echo $get_data['unit_fault_status']; ?>"
									selected="<?php echo $get_data['unit_fault_status']; ?>"><?php echo $get_data['unit_fault_status']; ?></option>";
