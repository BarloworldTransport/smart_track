...
$email_message="Vehicle : ".$data_message['vehicle_schedule_vehicle']. "<br>Date and Time : "
.$data_message['vehicle_schedule_date']." ".$data_message['vehicle_schedule_time']."<br>
...
<div class="notification_window">
    ...
    <div class="panel-body">
        <form class="schedule_notification" name="schedule_notification" method="post" action="../PHPMailer/send_schedule_notification.php">    

         	<div class="form-group">
            	<div class="input-group">

            		<div class="input-group-addon">To : </div>
            		<select id="unit_fault_unit_type" class=" form-control selectpicker" multiple data-live-search="true" name="contacts[]" Title="Please select a contact" required>
        	...
        	<input type="hidden" name="sr_number" value="<?php echo $sr_number ?>">
        </form>
        	           
     </div>

    </div>
     <button class="btn btn-success" type="submit" id="send" >Send Notification</button>
